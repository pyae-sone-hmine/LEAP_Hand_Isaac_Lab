...
class LeapHandEnvCfg3d(DirectRLEnvCfg):
    ...
    # reward scales
    z_rotation_steps = 16
    dynamic_goal_mode = False  # Automatically enabled by play.py when using --goal_angle
    ...
    enable_3d_rotation: bool = True
    rotation_steps_per_axis: int = 8  # Steps to complete full rotation per axis
